...
def make_stat():
    ...
    file1 = open(f'1lab/statistics.txt', 'w')
    ...
    plt.savefig('1lab/plot_times.png')
    plt.show()
    

if __name__ == "__main__":
    file = open('1lab/checking.txt', 'w')
    make_stat()
    for n in range(200, 2001, 200):
        mat1 = reading(f'1lab/1matrix/1_matrix{n}.txt')
        mat2 = reading(f'1lab/2matrix/2_matrix{n}.txt')
        mat_res = reading(f'1lab/res_matrix/res_matrix{n}.txt')
